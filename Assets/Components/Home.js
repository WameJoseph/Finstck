...
function open(event){
  ...
  const nodeList = document.querySelectorAll("#active > .answer");
  for (let i = 0; i < nodeList.length; i++) {
    nodeList[i].style.height = "fit-content";
  }
  
  const nodeList3 = document.querySelectorAll("#active > .top");
  for (let i = 0; i < nodeList.length; i++) {
    nodeList3[i].style.display = "none";
  }
  const nodeList2 = document.querySelectorAll("#active > .top2");
  for (let i = 0; i < nodeList.length; i++) {
...
function close(event){
  ...
  for (let i = 0; i < nodeList.length; i++) {
    ...
    // nodeList[i].style.back  = "0";

  }
  
  const nodeList3 = document.querySelectorAll("#active > .top");
  for (let i = 0; i < nodeList.length; i++) {
    nodeList3[i].style.display = "flex";
  }
  const nodeList2 = document.querySelectorAll("#active > .top2");
  for (let i = 0; i < nodeList.length; i++) {
        ...
        <section className='section7'>
          <div className="content">
            <div className="sp">
              ...
              <div className="scp" onClick={open}>
                <a className="top" >How does Finstack really work? <i className="material-icons">expand_more</i></a>
                <a className="top top2" onClick={close}>How does Finstack really work? <i className="material-icons">expand_less</i></a>
